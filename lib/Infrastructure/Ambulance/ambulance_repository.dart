...
import 'package:emergency_admin_app/Domain/Ambulance/i_ambulance_repo.dart';
import 'package:emergency_admin_app/Domain/Ambulance/model/ambulance_model/ambulance_model.dart';
...
class AmbulanceController implements IAmbulanceRepo {
  ...
  Future<void> deleteDoc(String id) async {
    try {
      final doc = FirebaseFirestore.instance.collection('ambulance').doc(id);
      await doc.delete();
    } catch (e) {
      log('err in: $e');
    }
  ...
  Future<void> completedDoc(String id, String completed, String reason,
    ...
    try {
      ...
      AmbulanceModel details = AmbulanceModel.fromJson(result);
      ...
      await FirebaseFirestore.instance
          .collection('completed_ambulance')
