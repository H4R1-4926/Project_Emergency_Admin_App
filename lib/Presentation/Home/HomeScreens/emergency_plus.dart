...
import 'package:emergency_admin_app/Infrastructure/Emergency_plus/emergency_plus_repo.dart';
import 'package:emergency_admin_app/Presentation/Detailed%20Page/detailed_em_plus_page.dart';
...
class EmergencyPlusEmPage extends StatelessWidget {
  EmergencyPlusEmPage({super.key});
                    ...
                    child: ListView.separated(
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () => Get.to(() => DetailedEmPlusPage(
                                data: data,
                                checkOnPressed: () {
                                  EmergencyPlusController().completedDoc(
                                      data.id,
                                  ...
                                  Future.delayed(
                                    ...
                                    EmergencyPlusController()
                                        .deleteDoc(data.id);
                                  });
                                },
                                deleteOnPressed: () {
                                  EmergencyPlusController().deleteDoc(data.id);
                                  Navigator.pushAndRemoveUntil(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => const HomePage(),
