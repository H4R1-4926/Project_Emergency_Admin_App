...
import 'package:emergency_admin_app/Infrastructure/Ambulance/ambulance_repository.dart';
...
class AmbulanceEmPage extends StatelessWidget {
  AmbulanceEmPage({super.key});
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () => Get.to(() => DetailPage(
                                    data: data,
                                    checkOnPressed: () {
                                      AmbulanceController().completedDoc(
                                          data.id,
                                    ...
                                    deleteOnPressed: () {
                                      AmbulanceController().deleteDoc(data.id);
                                      Navigator.pushAndRemoveUntil(
                                          context,
                                          MaterialPageRoute(
                                            builder: (context) =>
