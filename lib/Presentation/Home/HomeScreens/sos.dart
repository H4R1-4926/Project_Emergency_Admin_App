...
import 'package:emergency_admin_app/Infrastructure/Sos/sos_repository.dart';
...
class SosEmPage extends StatelessWidget {
  SosEmPage({super.key});
                            ...
                            onTap: () => Get.to(() => DetailPage(
                                ...
                                checkOnPressed: () {
                                  ...
                                  Future.delayed(
                                    ...
                                    SosController().deleteDoc(data.id);
                                  });
                                },
                                deleteOnPressed: () {
                                  SosController().deleteDoc(data.id);
